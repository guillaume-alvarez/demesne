...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        Type.objects.bulk_create([
            ...
            Type(name="Festival", slug="festival", cost=5, add_building=2, add_buy=1, add_gold=2),
            Type(name="Village", slug="village", cost=3, add_building=2, add_prestige=1),

            Type(name="Gold", slug="gold", cost=6, category=Type.PRESTIGE,add_gold=3,start_number=10,mandatory=True),
            Type(name="Silver", slug="silver", cost=3, category=Type.PRESTIGE,add_gold=2,start_number=20,mandatory=True),
            Type(name="Copper", slug="copper", cost=0, category=Type.PRESTIGE,add_gold=1,start_number=30,mandatory=True),
